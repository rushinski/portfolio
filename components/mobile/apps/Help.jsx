...
const FAQ = [
  ...
  { q: "How do I close an app?", a: "Tap the circular D-pad button on the phone bezel below the screen to return to the home screen." },
    ...
    <div style={{ padding: "12px 14px", background: "#f4f4f0", minHeight: "100%", fontFamily: W95_FONT }}>
      ...
      <div style={PANEL}>
        {[
          ...
          ["D-Pad Button", "The circular button on the phone bezel below the screen. Tap it to close any open app and return home."],
