...
export const MOBILE_APPS = [
  { id: "about",       label: "About Me",      icon: Icons.about,       desc: "Learn about Jacob — background, education, and interests." },
  ...
  { id: "resume",      label: "Resume",        icon: Icons.resume,      desc: "Download or view Jacob's full resume PDF." },
